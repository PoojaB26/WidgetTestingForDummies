...
class RecipeWithLongList extends StatefulWidget {
  @override
  _RecipeWithLongListState createState() => _RecipeWithLongListState();
}

class _RecipeWithLongListState extends State<RecipeWithLongList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Long List Of Ingredients'),
      ),
      body: Container(
